		  ...
		  void *data)
{
	...
	dropdown_button = DROPDOWN_BUTTON (data);
			 ...
			 GdkEventButton *event)
{
	...
	dropdown_button = DROPDOWN_BUTTON (widget);
	priv = dropdown_button->priv;
...
static void
class_init (DropdownButtonClass *klass)
{
...
static void
init (DropdownButton *dropdown_button)
{
	DropdownButtonPrivate *priv;

	priv = g_new (DropdownButtonPrivate, 1);
 ...
 **/
void
dropdown_button_construct (DropdownButton *dropdown_button,
			     ...
			     GtkMenu *menu)
{
	...
	g_return_if_fail (IS_DROPDOWN_BUTTON (dropdown_button));
 ...
 **/
GtkWidget *
dropdown_button_new (const char *label_text,
		       GtkMenu *menu)
{
	GtkWidget *widget;
