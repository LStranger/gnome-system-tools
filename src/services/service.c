...
const ServiceDescription descriptions[] = {
	...
	{ FALSE, "gnome-fs-nfs",       N_("Folder sharing service"),          N_("Shares folders over your network") },         /* GST_ROLE_FILE_SERVER_NFS */
	{ FALSE, "gnome-fs-ftp",       N_("FTP service"),                     N_("Shares folders over the Internet") },	        /* GST_ROLE_FILE_SERVER_FTP */
	{ FALSE, "gnome-fs-share",     N_("Folder sharing service"),          N_("Shares folders over the Internet") },	        /* GST_ROLE_FILE_SERVER_TFTP */
	...
	{ FALSE, NULL,                 N_("Firewall"),                        N_("Blocks undesired network "
										 "access to your computer") },                  /* GST_ROLE_FIREWALL_MANAGEMENT */
	{ FALSE, NULL,                 N_("Dictionary server"),               NULL }, /* GST_ROLE_DICTIONARY_SERVER */
	{ FALSE, NULL,                 N_("Speech synthesis support"),        NULL }, /* GST_ROLE_SPEECH_SYNTHESIS */
	...
	{ FALSE, NULL,                 N_("Application server"),              NULL }, /* GST_ROLE_APPLICATION_SERVER */
	...
	{ FALSE, NULL,                 N_("System configuration manager"),    NULL }, /* GST_ROLE_SYSTEM_CONFIGURATION_MANAGEMENT */
	{ FALSE, NULL,                 N_("School management platform"),      NULL }, /* GST_ROLE_SCHOOL_MANAGEMENT_PLATFORM */
	{ FALSE, NULL,                 N_("Network security auditor"),        NULL }, /* GST_ROLE_SECURITY_AUDITING */
	{ FALSE, NULL,                 N_("Web calendar server"),             NULL }, /* GST_ROLE_WEB_CALENDAR_SERVER */
	...
	{ FALSE, NULL,                 N_("Package index monitor"),           NULL }, /* GST_ROLE_PACKAGE_INDEX_MONITORING */
	...
	{ FALSE, NULL,                 N_("Audio settings management"),       NULL }, /* GST_ROLE_AUDIO_MANAGEMENT */
	...
	{ TRUE,  NULL,                 N_("Braille display management"),      NULL }, /* GST_ROLE_BRAILLE_DISPLAY_MANAGEMENT */
	{ FALSE, NULL,                 N_("Bluetooth device management"),     NULL }, /* GST_ROLE_BLUETOOTH_MANAGEMENT */
	{ FALSE, NULL,                 N_("Hard disk tuning"),                NULL }, /* GST_ROLE_HDD_MANAGEMENT */
	...
	{ TRUE,  NULL,                 N_("RAID disks management"),           NULL }, /* GST_ROLE_RAID_MANAGEMENT */
