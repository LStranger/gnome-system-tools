...
gchar *s = N_("<span weight=\"bold\">Group settings</span>");
...
gchar *s = N_("*");
gchar *s = N_("*");
gchar *s = N_("<span weight=\"bold\">Password options</span>");
