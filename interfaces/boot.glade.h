...
gchar *s = N_("_Delete");
gchar *s = N_("_Edit...");
gchar *s = N_("<span weight=\"bold\">Starting your computer</span>");
...
gchar *s = N_("<span weight=\"bold\">Basic</span>");
gchar *s = N_("_Name:");
...
gchar *s = N_("_Append:");
gchar *s = N_("*");
gchar *s = N_("<span weight=\"bold\">Image</span>");
gchar *s = N_("*");
gchar *s = N_("*");
gchar *s = N_("_Edit parameters");
gchar *s = N_("<span weight=\"bold\">Other</span>");
gchar *s = N_("_Device:");
gchar *s = N_("*");
...
gchar *s = N_("Scsi emulation devices");
gchar *s = N_("/dev/hdb");
gchar *s = N_("/dev/hdd");
gchar *s = N_("/dev/hdc");
gchar *s = N_("/dev/hda");
gchar *s = N_("Other options");
gchar *s = N_("*");
