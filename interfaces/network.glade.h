...
gchar *s = N_("General");
gchar *s = N_("How the IP address for this connection\n"
              "is determined.");
...
gchar *s = N_("_Phone number:");
gchar *s = N_("*");
gchar *s = N_("Number to get to an _external line:");
gchar *s = N_("*");
gchar *s = N_("To continue configuring your network connection, click \"Next\". To quit, click \"Cancel\".");
...
gchar *s = N_("Network profiles can be used to store\n"
              "different network configurations.");
gchar *s = N_("_Save Current");
gchar *s = N_("New network profile - GNOME System Tools");
gchar *s = N_("Please, give this network profile\n"
